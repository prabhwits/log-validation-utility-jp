    ...
    const getResponse = (apiSeq: any, data: any, msgIdSet: any) => {
      switch (apiSeq) {
        ...
        case ApiSequence.ON_UPDATE_PART_CANCEL:
          return checkOnUpdate(data, msgIdSet, ApiSequence.ON_UPDATE_PART_CANCEL, settlementDetatilSet, fulfillmentsItemsSet, "6-a")
        ...
        case ApiSequence.ON_UPDATE_INTERIM_REVERSE_QC:
          return checkOnUpdate(data, msgIdSet, ApiSequence.ON_UPDATE_INTERIM_REVERSE_QC, settlementDetatilSet, fulfillmentsItemsSet, '6-b')
        case ApiSequence.ON_UPDATE_APPROVAL:
          return checkOnUpdate(data, msgIdSet, ApiSequence.ON_UPDATE_APPROVAL, settlementDetatilSet, fulfillmentsItemsSet, "6-b")
        case ApiSequence.ON_UPDATE_PICKED:
          return checkOnUpdate(data, msgIdSet, ApiSequence.ON_UPDATE_PICKED, settlementDetatilSet, fulfillmentsItemsSet, "6-b")
        ...
        case ApiSequence.ON_UPDATE_INTERIM_LIQUIDATED:
          return checkOnUpdate(data, msgIdSet, ApiSequence.ON_UPDATE_INTERIM_LIQUIDATED, settlementDetatilSet, fulfillmentsItemsSet, "6-c")
        case ApiSequence.ON_UPDATE_LIQUIDATED:
          return checkOnUpdate(data, msgIdSet, ApiSequence.ON_UPDATE_LIQUIDATED, settlementDetatilSet, fulfillmentsItemsSet, "6-c")
